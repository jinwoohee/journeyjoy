...
<script>
	$(function(){
		...
		$('select[name=nation]').change(function(){
			if($('select[name=nation]').val() == "japan"){
				$('#japan').show();
				$('#canada').hide();
			}else if($('select[name=nation]').val() == "canada"){
				$('#canada').show();
				$('#japan').hide();
			}else{
				$('select[name=city]').hide();
					...
					<tr>
						<td>
							<select name="nation" size="1">
					    		<option value="nation_choice">국가</option>
					    		<option value="japan">일본</option>
					    		<option value="canada">캐나다</option>
						  	</select>
						  	<select name="city" size="1" id="japan">
					    		<option value="choice">도시</option>
					    		<option value="tokyo">도쿄</option>
					    		<option value="osaka">오사카</option>
						  	</select>
						  	<select name="city" size="1" id="canada">
					    		<option value="choice">도시</option>
